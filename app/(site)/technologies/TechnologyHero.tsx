...
const words = [ "Cloud", "Big Data", "IoT", "Blockchain", "DevOps",
  "Machine Learning", "5G", "Cybersecurity", "Quantum Computing"]
    ...
    <section className="py-20 bg-white dark:bg-black overflow-hidden relative">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Explore our comprehensive ecosystem of advanced technologies
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
