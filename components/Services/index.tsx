      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 text-center">
          <button
            ...
            className="relative inline-flex items-center px-8 py-4 text-sm font-medium
                     overflow-hidden rounded-xl group"
          >
            <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-blue-600 to-purple-600 opacity-70 group-hover:opacity-100 transition-opacity duration-300" />
